...
test('order.service createPayments ok', function (t) {
  ...
  t.equal(pp[0].processingFees.achFeeFlatActual, 0)
  t.equal(pp[0].processingFees.achFeeDisplay, 0)
  t.equal(pp[0].processingFees.achFeeActual, 0)
  t.equal(pp[0].processingFees.cardFeeFlatDisplay, 0.3)
  t.equal(pp[0].processingFees.cardFeeFlatActual, 0.3)
  t.equal(pp[0].processingFees.cardFeeDisplay, 2.9)
  t.equal(pp[0].processingFees.cardFeeActual, 2.9)
  t.end()
})
